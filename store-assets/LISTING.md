...
```
Most dark-mode extensions invert every page, including the ones that already look great in dark mode. Better Simple Auto Dark Mode is smarter:
...
PRIVACY
No analytics. No telemetry. No remote code. The extension stores three things in your browser's local storage (on/off toggle, slider value, whitelist) and never transmits anything anywhere. Open source — see the code at github.com/dongt10/better-simple-auto-dark-mode.
...
```
https://dongt10.github.io/better-simple-auto-dark-mode/privacy.html
```
...
```
https://github.com/dongt10/better-simple-auto-dark-mode
```
...
```
https://github.com/dongt10/better-simple-auto-dark-mode/issues
```
